...
namespace WebApp.SamplePages
{
    public partial class FilterSearches : System.Web.UI.Page
    {
        ...
        protected void ProductGridViewV1_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            //the new page index to display is found in your
            //    method parameter GridViewPageEventArgs e
            //set the gridview control property .PageIndex to the
            //    argument value e.NewPageIndex
            ProductGridViewV1.PageIndex = e.NewPageIndex;

            //refresh your gridview by doing your query search again
            //Since the event argument object is different, 
            //    a instance of the OnClick general event object
            //    is created and passed to the query method.
            EventArgs newArgs = new EventArgs();
            CategoryList_SelectedIndexChanged(sender, newArgs);
        }
    }
}